% Olivine Fo90 flow law parameters in the presence of water
% from Hirth and Kohlstedt, 2003 (and others after) ======================= 
% c = Coble Diffusion creep (GB)
olv_Fo90.HK03.diff.Ac = 2.5e7 ; % preexponential for coble diffusion creep
...
olv_Fo90.HK03.diff.rH2O = 1.0 ; % melt factor

% d = Dislocation creep 
olv_Fo90.HK03.disl.Ad = 1600 ; % preexponential  
olv_Fo90.HK03.disl.Qd = 520e3 ;% activation energy 
...
olv_Fo90.HK03.disl.rH2O = 1.2 ; % melt factor
