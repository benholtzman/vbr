...
%% box name without the 'Box_' prefix   
   if whoops == 1
       Work.Box_base_name='2016-07-22-re_Tpot_Vbg_conXf';
   elseif whoops == 2
       Work.Box_base_name='2016-07-22-re_Tpot_zLAB_varXf';
   elseif whoops == 3
       Work.Box_base_name='2016-07-22-re_Tpot_Vbg_varXf';
   elseif whoops == 4
       Work.Box_base_name='2016-07-22-re_Vbg_zLAB_conXf';
   elseif whoops == 5
       Work.Box_base_name='2016-07-22-re_Tpot_zLAB_conXf';
   elseif whoops == 6
       Work.Box_base_name='2016-07-22-re_Vbg_zLAB_varXf';
   end
...
%% new VBR box name  
   Work.Box_out_suffix='_VBR_meltfree';   
...
%% set frequency to calculate over   
   VBR.in.SV.f =  0.1; % [Hz] %logspace(-2.2,-1.3,10);
...
%%         Store the VBR structure in the current frame
           VBRstore=VBR;
           VBRstore.in=rmfield(VBRstore.in,'SV');
           Frames(ifr).VBR = VBR ;
       end
